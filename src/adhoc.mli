...
val print_paths : Filepath.t list -> unit
...
val scrape_arch_of_filepath : Filepath.t -> Os.Arch.t option
(** [scrape_arch_of_filepath file] tries to determine an architecture
    from [file] by starting from the end of the path. *)

val get_arch_of_file : arch:Os.Arch.t option -> Filepath.t -> Os.Arch.t
