...
val conf_envs : Cmd.Env.info list
val conf : Telvm_conf.t Term.t
val resolved : bool Term.t
val force : bool Term.t
val dry_run : bool Term.t
val with_shutdown : bool Term.t

val image_partition_scheme : Image.partition_scheme Term.t
val image_file_system : Image.file_system Term.t
