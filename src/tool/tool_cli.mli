...
val data_dir_path_conv : Filepath.t Arg.Conv.t
val drive_device_and_data_dir_path_conv :
  (Qemu.drive_device option * Filepath.t) Arg.Conv.t
val image_path_conv : Filepath.t Arg.Conv.t
...
val err_file_exists_use_force : Filepath.t -> string
val err_not_dir : Filepath.t -> string
val err_not_file_or_dir : Filepath.t -> string
val err_no_such_file_or_dir : Filepath.t -> string
